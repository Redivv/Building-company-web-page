...
function mailsend($txt='', $header='' , $mail='Fhu.krzycho@gmail.com'){
        // Naglowki mozna sformatowac tez w ten sposob.
        $naglowki = "From: FHU Krzycho <info@jakubrajca.pl>".PHP_EOL;
	...
	if(count($errors)>0){
		...
		$txt  = '<b>Imię:</b> '.$name.'<br>';
		$txt .= '<b>Adres email:</b> '.$email.'<br>';
		$txt .= '<b>Treść:</b> '.$text.'<br>';
		mailsend($txt, "Wiadomość ze strony FHU Krzycho");
	}
